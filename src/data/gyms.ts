...
/** 5 batalhas por ginásio: 3 treinadores + mini boss + líder (2 Pokémon por time) */
export const GYM_TRAINER_STAGES: Record<GymId, GymTrainerStage[]> = {
  brock: [
    { stage: 1, trainerName: "Campeão Júnior", label: "Treinador", pokemonIds: [74, 27], difficultyScale: 0.85 },
    { stage: 2, trainerName: "Hiker Marcus", label: "Intermediário", pokemonIds: [74, 75], difficultyScale: 0.95 },
    { stage: 3, trainerName: "Rock Crusher", label: "Forte", pokemonIds: [75, 95], difficultyScale: 1.05 },
    { stage: 4, trainerName: "Graveler Guard", label: "Mini Boss", pokemonIds: [76, 95], difficultyScale: 1.15 },
    { stage: 5, trainerName: "Brock", label: "Líder", pokemonIds: [74, 95], difficultyScale: 1.25 },
  ],
  misty: [
    { stage: 1, trainerName: "Swimmer Amy", label: "Treinador", pokemonIds: [60, 118], difficultyScale: 0.85 },
    { stage: 2, trainerName: "Fisher Kai", label: "Intermediário", pokemonIds: [61, 119], difficultyScale: 0.95 },
    { stage: 3, trainerName: "Wave Rider", label: "Forte", pokemonIds: [55, 87], difficultyScale: 1.05 },
    { stage: 4, trainerName: "Tentacruel Tide", label: "Mini Boss", pokemonIds: [73, 121], difficultyScale: 1.15 },
    { stage: 5, trainerName: "Misty", label: "Líder", pokemonIds: [120, 121], difficultyScale: 1.25 },
  ],
  surge: [
    { stage: 1, trainerName: "Engineer Volt", label: "Treinador", pokemonIds: [100, 81], difficultyScale: 0.85 },
    { stage: 2, trainerName: "Shock Trooper", label: "Intermediário", pokemonIds: [101, 82], difficultyScale: 0.95 },
    { stage: 3, trainerName: "Thunder Squad", label: "Forte", pokemonIds: [125, 101], difficultyScale: 1.05 },
    { stage: 4, trainerName: "Electrode Core", label: "Mini Boss", pokemonIds: [101, 125], difficultyScale: 1.15 },
    { stage: 5, trainerName: "Lt. Surge", label: "Líder", pokemonIds: [26, 101], difficultyScale: 1.25 },
  ],
  erika: [
    { stage: 1, trainerName: "Gardener Leaf", label: "Treinador", pokemonIds: [43, 69], difficultyScale: 0.85 },
    { stage: 2, trainerName: "Bloom Keeper", label: "Intermediário", pokemonIds: [44, 70], difficultyScale: 0.95 },
    { stage: 3, trainerName: "Vine Master", label: "Forte", pokemonIds: [45, 71], difficultyScale: 1.05 },
    { stage: 4, trainerName: "Exeggutor Grove", label: "Mini Boss", pokemonIds: [71, 103], difficultyScale: 1.15 },
    { stage: 5, trainerName: "Erika", label: "Líder", pokemonIds: [45, 71], difficultyScale: 1.25 },
  ],
  koga: [
    { stage: 1, trainerName: "Ninja Trainee", label: "Treinador", pokemonIds: [41, 48], difficultyScale: 0.85 },
    { stage: 2, trainerName: "Poison Fang", label: "Intermediário", pokemonIds: [42, 49], difficultyScale: 0.95 },
    { stage: 3, trainerName: "Toxic Cloud", label: "Forte", pokemonIds: [89, 110], difficultyScale: 1.05 },
    { stage: 4, trainerName: "Muk Shadow", label: "Mini Boss", pokemonIds: [89, 34], difficultyScale: 1.15 },
    { stage: 5, trainerName: "Koga", label: "Líder", pokemonIds: [42, 89], difficultyScale: 1.25 },
  ],
  sabrina: [
    { stage: 1, trainerName: "Psychic Adept", label: "Treinador", pokemonIds: [63, 96], difficultyScale: 0.85 },
    { stage: 2, trainerName: "Mind Bender", label: "Intermediário", pokemonIds: [64, 97], difficultyScale: 0.95 },
    { stage: 3, trainerName: "Telekinetic", label: "Forte", pokemonIds: [65, 97], difficultyScale: 1.05 },
    { stage: 4, trainerName: "Hypno Dream", label: "Mini Boss", pokemonIds: [97, 65], difficultyScale: 1.15 },
    { stage: 5, trainerName: "Sabrina", label: "Líder", pokemonIds: [64, 97], difficultyScale: 1.25 },
  ],
  blaine: [
    { stage: 1, trainerName: "Ember Spark", label: "Treinador", pokemonIds: [58, 77], difficultyScale: 0.85 },
    { stage: 2, trainerName: "Flame Dancer", label: "Intermediário", pokemonIds: [59, 78], difficultyScale: 0.95 },
    { stage: 3, trainerName: "Inferno Knight", label: "Forte", pokemonIds: [59, 126], difficultyScale: 1.05 },
    { stage: 4, trainerName: "Magmar Forge", label: "Mini Boss", pokemonIds: [126, 136], difficultyScale: 1.15 },
    { stage: 5, trainerName: "Blaine", label: "Líder", pokemonIds: [58, 126], difficultyScale: 1.25 },
  ],
  giovanni: [
    { stage: 1, trainerName: "Rocket Grunt", label: "Treinador", pokemonIds: [52, 50], difficultyScale: 0.85 },
    { stage: 2, trainerName: "Rocket Elite", label: "Intermediário", pokemonIds: [53, 51], difficultyScale: 0.95 },
    { stage: 3, trainerName: "Ground Force", label: "Forte", pokemonIds: [111, 51], difficultyScale: 1.05 },
    { stage: 4, trainerName: "Rhydon Crusher", label: "Mini Boss", pokemonIds: [112, 51], difficultyScale: 1.15 },
    { stage: 5, trainerName: "Giovanni", label: "Líder", pokemonIds: [111, 112], difficultyScale: 1.25 },
  ],
};
...
export function getTeamGymReadiness(
  ...
  const teamComplete = team.length >= BATTLE_TEAM_SIZE;
  if (!teamComplete) {
